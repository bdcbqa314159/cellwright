...
// ── Reference adjustment for row/column insert/delete ─────────────────────
...
std::string Clipboard::adjust_for_insert_row(const std::string& formula, int32_t at) {
    return adjust_refs_impl(formula, true, at, 1);
}
std::string Clipboard::adjust_for_delete_row(const std::string& formula, int32_t at) {
    return adjust_refs_impl(formula, true, at, -1);
}
std::string Clipboard::adjust_for_insert_col(const std::string& formula, int32_t at) {
    return adjust_refs_impl(formula, false, at, 1);
}
std::string Clipboard::adjust_for_delete_col(const std::string& formula, int32_t at) {
    return adjust_refs_impl(formula, false, at, -1);
}
